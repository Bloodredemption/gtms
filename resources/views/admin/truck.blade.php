      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 mb-4">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Truck Records</h3>
                  <h6 class="font-weight-normal mb-0">All registered trucks will be listed here.</h6>
                </div>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary mb-4">Add Truck</button>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024.   <a href="https://www.bootstrapdash.com/" target="_blank">Garbage Truck Monitoring System.</a>  All rights reserved.</span>
